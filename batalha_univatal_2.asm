...
.DATA
    ...
    posicoes_jogador_1 DB "00000000000000000000000000000000",0
    cont_tab_1 DB 0
...
loop_game:
    ...
    player_joga: 
        ...
        jne pula_player_venceu
          ...
          ;;;; DESENHA TABULEIRO adversario
          ;; parametros var_objeto,orientacao_escrita,posX,posY     
          mov cont_tab_1,0
          mov cont_tab_2,12
          PUSHA
          PUSH CX
...
jmp loop_game 
 ...
 revela:
            ...
            revela_tab_1:    
                ...
                mov DI, CX 
                MOV AH,0
                mov AL,posicoes_jogador_1[DI]
                mov var_objeto,AL
                mov AL,posicoes_jogador_1[DI+1]
                mov orientacao_escrita,AL
                mov AL,posicoes_jogador_1[DI+2]
                mov posX,AX
                mov AL,posicoes_jogador_1[DI+3]
                mov posY,AX
                mov var_tabuleiro, 1
                call _desenha_objeto
                cmp cont_tab_1,11
...
salva_pos_tab:
    cmp player,1
    je salva_orientacao_player1
    jmp salva_orientacao_player2
    
    salva_orientacao_player1:    
        MOV CL, cont_tab_1
        MOV DI,0
        mov DI, CX
        mov posicoes_jogador_1[DI],AL
        inc cont_tab_1            
        ret
    salva_orientacao_player2:
        MOV CL, cont_tab_2
        MOV DI,0
        mov DI, CX
        mov posicoes_jogador_1[DI],AL
