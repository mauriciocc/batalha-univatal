...
.DATA
    ...
    mensagem_valor1 DB "ESCOLHA UM DOS SEGUINTES OBJETOS QUE DESEJA POSICIONAR NO TABULEIRO:              {1}- BARRIL, {2}- BOTE, {3}- LANCHA, {4}- BARCACA",0
    mensagem_valor2 DB "DIGITE A ORIENTACAO DO OBJETO: ",0
    mensagem_valor3 DB "DIGITE O NUMERO COLUNA E O NUMERO DA LINHA DE 1 A 8 ",0
